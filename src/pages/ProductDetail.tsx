        ...
        <div className="container-custom">
                      ...
                      style={{
                        backgroundColor:
                          color.toLowerCase() === "gold"
                            ...
                            ? "#C0C0C0"
                            : color.toLowerCase() === "white gold"
                            ? "#E8E8E8"
                            : color.toLowerCase() === "yellow gold"
                            ? "#FFDF00"
                            : color.toLowerCase() === "rose gold"
                            ? "#B76E79"
                            : color.toLowerCase() === "white pearl"
                            ? "#F5F5F5"
          ...
          <div className="mb-16">
            <Tabs defaultValue="details">
              ...
              <TabsContent
                value="details"
                className="p-6 bg-neutral-50 rounded-md"
              >
              ...
              >
                ...
                <p className="mb-4">
                  This product is crafted using only the finest materials:
                </p>
                ...
                {product.category === "bags" && (
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>Clean with a soft, dry cloth</li>
                    <li>
                      For leather bags, apply leather conditioner occasionally
                    </li>
                  </ul>
                )}
                {product.category === "footwear" && (
              ...
              >
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      Items must be returned in original packaging with all tags
                      attached
                    </li>
                    <li>
