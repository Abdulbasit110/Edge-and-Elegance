      ...
      <main className="flex-grow pt-28">
        ...
        <div className="relative h-[40vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-20">
            <h1 className="font-serif text-4xl md:text-5xl font-medium mb-4">Women's Collection</h1>
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className={`w-full md:w-64 ${isFilterOpen ? 'block' : 'hidden'} md:block`}>
                <div className="bg-white p-6 border border-neutral-200 rounded-lg">
                  ...
                  {/* Price Range */}
                  <div>
                    <h4 className="font-medium text-sm uppercase tracking-wider mb-3">Price Range</h4>
                    <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredProducts.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-12">
                      <p className="text-lg text-neutral-600">No products found with the selected filters.</p>
                      <Button 
                        variant="outline" 
                        className="mt-4"
                        onClick={() => {
